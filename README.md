...
_Continuous Control_ is the second project of the Deep Reinforcement Learning Udacity Nanodegree. Part of the description below was provided by the instructors.
...
This will save a plot of the score through the different episodes, and two checkpoint files (one for the actor and one for the critic). 
